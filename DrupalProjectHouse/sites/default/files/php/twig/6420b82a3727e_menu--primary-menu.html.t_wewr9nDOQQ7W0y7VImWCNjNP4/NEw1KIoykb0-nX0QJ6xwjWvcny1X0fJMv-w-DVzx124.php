...
class __TwigTemplate_bae4a1e00b5616b41c923762dd9ddf0b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "themes/january_theme/templates/navigation/menu--primary-menu.html.twig", "C:\\xampp\\htdocs\\DrupalProjectHouse\\themes\\january_theme\\templates\\navigation\\menu--primary-menu.html.twig");
    }
